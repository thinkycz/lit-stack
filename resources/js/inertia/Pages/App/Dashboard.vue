                    ...
                    <li class="activeLink">
                        <inertia-link :href="$route('app.dashboard')"
                           class="py-3 pl-1 w-full flex items-center focus:outline-none focus-visible:underline">
                            <svg class="h-6 w-6 transition-all ease-out transition-medium text-gray-500"
                            ...
                            <span class="ml-3 text-sm font-medium transition-all ease-out transition-medium text-gray-700">Dashboard</span>
                        </inertia-link>
                    </li>
                    <li>
                        <inertia-link :href="$route('app.dashboard')"
                           class="py-3 pl-1 w-full flex items-center focus:outline-none focus-visible:underline">
                            <svg class="h-5 w-5 ml-1 transition-all ease-out transition-medium text-gray-500 left1"
                                ...
                                <g class="fa-group">
                                    <path fill="currentColor" d="M351.75 168a128 128 0 0 1-255.5 0z"
                                          class="fa-secondary"></path>
                                    <path fill="currentColor"
                            ...
                            <span class="ml-3 text-sm font-medium transition-all ease-out transition-medium text-gray-700">Users</span>
                        </inertia-link>
                    </li>
                    <li>
                        <inertia-link :href="$route('app.dashboard')"
                           class="py-3 pl-1 w-full flex items-center focus:outline-none focus-visible:underline">
                            ...
                            <span class="ml-3 text-sm font-medium transition-all ease-out transition-medium text-gray-700">Integrations</span>
                        </inertia-link>
                    </li>
                </ul>
            </nav>

            <div class="w-full bg-white rounded-lg mx-auto px-10 py-8">
                <h1 class="text-2xl font-medium mb-2">Dashboard</h1>
                <h2 class="font-medium text-sm text-gray-500 mb-4 uppercase tracking-wide">This is your dashboard</h2>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Delectus dolore eligendi et ex harum
                    sapiente! Animi culpa cum cupiditate eligendi eveniet harum necessitatibus nesciunt, officiis,
                    sapiente sequi unde vero voluptatum!</p>
            </div>
        </div>
    </app-layout>
</template>
