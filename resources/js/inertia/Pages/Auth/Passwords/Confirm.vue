                ...
                <form @submit.prevent="submit"
                    ...
                    <div
                        ...
                        <div class="flex-1 absolute bottom-0 text-white p-10">
                            <h3 class="text-2xl font-bold inline-block">Confirm Password</h3>
                    ...
                    <div class="flex-1 p-6 sm:p-10 sm:py-12">
                        <h3 class="text-xl text-gray-700 font-bold mb-6">
                            Please confirm <span class="text-gray-400 font-light">your password before continuing</span></h3>
